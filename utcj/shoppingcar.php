...
<a id="btnEmpty" href="shoppingcar.php?action=empty">Empty Cart</a>
<?php
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="shoppingcar.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			<form method="post" action="shoppingcar.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
